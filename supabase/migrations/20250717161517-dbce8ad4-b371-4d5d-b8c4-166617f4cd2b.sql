...
-- Enable RLS on the metrics view
...
-- Create index for better performance on metrics queries
CREATE INDEX idx_transactions_user_month ON public.transactions (user_id, DATE_TRUNC('month', transaction_date));
CREATE INDEX idx_transactions_date ON public.transactions (transaction_date);
CREATE INDEX idx_transactions_user_item ON public.transactions (user_id, item_name);